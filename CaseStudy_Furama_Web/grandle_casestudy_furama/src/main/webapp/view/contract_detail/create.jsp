                    ...
                    <div class="card-body">
                        <div class="row gutters row__start">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <h3 class="mb-2 text-primary">Contact Details</h3>
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                <div class="form-group">
                                    <label>Contract</label>
                                    <select class="form-control"  name="contract_id" style="font-size: 2rem;height: 40px">
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-control"  name="attach_service_id" style="font-size: 2rem;height: 40px">
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                <div class="form-control">
                                    ...
                                    <input name="quantity" type="text" class="form-control" id="phone" placeholder="Enter Employee Birthday">
                                </div>
                            </div>
                        </div>
                        <div class="row gutters row__start">
