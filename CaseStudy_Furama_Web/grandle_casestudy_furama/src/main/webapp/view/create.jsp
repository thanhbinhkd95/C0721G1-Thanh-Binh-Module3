                    ...
                    <div class="row gutters row__start">
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="fullName" placeholder="Enter ID">
                            </div>
                        </div>
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                            <div class="form-group">
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                            <div class="form-group">
                                ...
                                <input type="url" class="form-control" id="website" placeholder="Email">
                            </div>
                        </div>
                    </div>
                    <div class="row gutters row__start">
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                            <div class="form-group">
                                <label for="Street">Day of Birth</label>
                                <input type="name" class="form-control" id="Street" placeholder="Day of Birth">
                            </div>
                        </div>
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                            <div class="form-group">
                    ...
                    <div class="row gutters row__start">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="text-right">
                                ...
                                <button type="button" id="submit1" name="submit" class="btn btn-primary">Create</button>
                            </div>
                        </div>
                    </div>
                </div>
